...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        TrainingPlan tB = new TrainingPlan('B', 10, 6);
        ...
        for (Swimmer s : swimmers) {
            if (s.hasPlan()) {
                System.out.println(s.getName() + " træner " + s.allTrainingHours() + " timer om ugen");
                System.out.println();
            } else {
                System.out.println(s.getName() + " mangler en plan");
                System.out.println();
            }
        }
