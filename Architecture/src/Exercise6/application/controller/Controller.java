package Exercise6.application.controller;

import Exercise6.application.model.Company;
import Exercise6.application.model.Customer;
import Exercise6.application.model.Employee;
import Exercise6.storage.Storage;
...
public class Controller {
    ...
    public static void initStorage() {
        ...
        Controller.createEmployee("Bob Dole", 210, c2, 2011);
        Controller.createEmployee("Alice Schmidt", 250, c1, 1995);
        Controller.createEmployee("George Down", 150, c2, 2015);
