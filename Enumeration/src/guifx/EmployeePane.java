...
public class EmployeePane extends GridPane {
	...
	public EmployeePane() {
		...
		lvwEmployees.setPrefHeight(150);
	...
	public void updateControls() {
		...
		if (employee != null) {
			...
			txfHours.setText("" + employee.getHours());
