package Exercise3.Gui;

import Exercise3.Application.Controller.CustomerController;
...
public class CompanyPane extends GridPane {
	...
	private void orderByName() {
		lvwCompanies.getItems().setAll(CustomerController.selectionSortName(CustomerController.getCustomers()));
	}
